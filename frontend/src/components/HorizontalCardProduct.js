                    ...
                    loadingList.map((_, index) => {
                      return (
                        <div key={index} className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex">
                          <div className="bg-slate-200 h-full p-4 animate-pulse min-w-[120px] md:min-w-[145px]">
                          </div>
                          <div className="p-4 grid w-full gap-2">
                            <h2 className="font-medium text-base text-ellipsis line-clamp-1 md:text-lg text-black bg-slate-200 animate-pulse p-1 rounded-full">
